...
public class DexFileReader {
    ...
    protected static final Logger log = Logger.getLogger(DexFileReader.class.getName());
    ...
    protected boolean apiLevelSetted = false;
    ...
    public DexFileReader(DataIn in) {
        ...
        if (odex) {
            ...
            DexConfigure.displayMessage("After initial header section, the abs position: "+((OffsetedDataIn)in).getAbsCurrentPosition());
            // the original code one line below
            in.skip(8);// skip head;
            
        }        
        DexConfigure.displayMessage("After initial header section, the position: "+in.getCurrentPosition());
        // skip uint checksum
        ...
        DexConfigure.displayMessage("The endian_tag: "+endian_tag);
        ...
        DexConfigure.displayMessage("After header section, the position: "+in.getCurrentPosition());
    }
    ...
    public void accept(DexFileVisitor dv, int config) {
        ...
        DexConfigure.displayMessage("accept: position: "+in.getCurrentPosition());
        ...
        DataIn in = this.in;
        DexConfigure.displayMessage("class_defs_size: "+class_defs_size);
    ...
    private void acceptClass(DexFileVisitor dv, DexClassVisitor dcv, String className, int config) {
        ...
        DexConfigure.displayMessage("acceptClass: position: "+in.getCurrentPosition());
    ...
    /* default */
    protected Field getField(int id) {
    ...
    /* default */
    protected Method getMethod(int method_idx) {
